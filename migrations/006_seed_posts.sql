...
SELECT
  ...
  '질문',
  '이 카드 효과 해석이 맞나요?',
  '[{"type":"text","value":"3번 카드에 적힌 효과가 헷갈려서요. 이번 라운드에 획득한 자원을 두 배로 한다는 게 이미 획득한 자원에도 적용되는 건가요, 아니면 이 카드 이후에 획득하는 자원에만 적용되는 건가요? 규칙서를 봤는데도 명확하지 않아서 질문드립니다."}]',
  0,
  18,
  4,
  7,
...
SELECT
  ...
  '공략',
  '초반 자원 확보가 핵심입니다',
  '[{"type":"text","value":"여러 번 플레이해보니까 초반 3라운드 안에 자원을 최대한 많이 확보하는 게 승패를 좌우하더라고요. 특히 목재와 철광은 우선순위를 높게 가져가는 게 좋고, 초반에 행동 카드보다는 자원 카드 위주로 뽑는 전략을 추천합니다."}]',
  0,
  87,
  31,
  12,
...
SELECT
  ...
  '유머',
  '보드게이머들이 통장이 얇아지는 이유',
  '[{"type":"text","value":"1. 신작 나왔다는 유튜브 영상 발견. 2. 이건 꼭 해봐야해 다짐. 3. 배송비 아까우니까 다른 것도 같이 주문. 4. 박스 쌓여가는 거 보면서 뿌듯함. 5. 새로운 신작 나왔다는 유튜브 영상 발견. 이 굴레에서 벗어날 수가 없습니다."}]',
  0,
  321,
  89,
  33,
...
SELECT
  ...
  '모임후기',
  '어제 보드게임 모임 후기 (6인 풀방!)',
  '[{"type":"text","value":"드디어 6인 풀방으로 플레이했어요! 인원이 많다 보니까 대기 시간이 좀 있었지만 그래도 즐거운 시간이었습니다. 첫 번째로 웰컴투 했는데 역시 입문용으로는 최고인 것 같아요. 다음 달에 또 모이기로 했는데 그때는 빌리지 도전해보려고요!"}]',
  0,
  98,
  41,
  22,
